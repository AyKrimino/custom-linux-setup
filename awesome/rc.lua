...
globalkeys = gears.table.join(
	...
	---- Vim‑style swap: Alt+Shift+h/j/k/l
	...
	-- Volume control via hardware keys
	...
	-- Brightness control via hardware keys
...
awful.spawn.with_shell([[
  ...
  xinput set-prop "PNP0C50:00 06CB:7E7E Touchpad" "libinput Natural Scrolling Enabled" 1
  xinput set-prop "PNP0C50:00 06CB:7E7E Touchpad" "libinput Scroll Method Enabled" 0, 0, 1
]])
